...
class mayorizacion_class {
    ...
    var $Conexion;    
     ...
     // TIDU
    function secu_asto($Conexion, $idempresa,  $sucursal, $modulo, $fecha_mov, $user_ifx, $tidu, $tipoComp) {
            // ASIENTO CONTABLE
            ...
            //      MES
            list($idprdo,$d,$a) = explode('/', $fecha_mov);
    ...
    function saeasto($Conexion,  $secu_asto,  $idempresa,  $sucursal,    $idejer,      $idprdo, $moneda, $user_ifx, $tran, $clpv_nom,
                          $total_vta, $fecha_asto, $detalle_asto, $secu_dia,  $fecha_emis , $tidu,   $usua_nom, $user_web, $modulo, $tipoComp) {
            // SAEASTO
            $sql = "insert into saeasto (  asto_cod_asto,       asto_cod_empr,      asto_cod_sucu,      asto_cod_ejer,
                              ...
                              values(  '$secu_asto',            $idempresa,         $sucursal,          $idejer,
                                       ...
                                       '$tipoComp',                    1,                   8,                  '$tidu',
                                       '$usua_nom',             CURRENT_DATE,            $user_web  )";
            $Conexion->QueryT($sql);
            return 'OK';
    }
    
    function saedasi($Conexion, $idempresa, $sucursal, $cuenta, $idprdo, $idejer, $ccos, $debml, $crml, $debme, $crme, $tip_camb,
                  $det_dasi, $clpv_cod,  $tran, $user_web, $secu_asto){
            ...
            $sql = "insert into saedasi (asto_cod_asto,        asto_cod_empr,      asto_cod_sucu,       dasi_num_prdo,
                                          ...
                                          dasi_cru_dasi,	   dasi_num_depo $tmp1)
    ...
    function saedir($Conexion, $idempresa, $sucursal, $idprdo, $idejer, $asto_cod, $clpv_cod, $modu_cod , $tran_cod ,
                    ...
                    $impr,      $fac_ini,   $fac_fin,   $serie,  $fec_auto, $user_web, $cod_dir , $tcam, $clpv_nom, 
					$ccli,		$cobrador){
            $sql = "insert into saedir( dir_cod_dir,            dire_cod_asto,      dire_cod_empr,      dire_cod_sucu,
                               ...
                               values( $cod_dir,              '$asto_cod',        $idempresa,          $sucursal,
                                       ...
                                       $sucursal,              $user_web ,        '$clpv_nom', 	   		'$ccli',
										'$cobrador');  ";
            $Conexion->QueryT($sql);
            return 'OK';
    }
    ...
    function saeret($Conexion, $idempresa, $sucursal, $idprdo, $idejer, $asto_cod, $clpv_cod, $clpv_nom, $clpv_dir, $clpv_tel, 
                    ...
                    $deb_me, $cre_me, $factura,  $serie, $auto_sri, $fec_ret,  $correo, $elect_sn, $origen){
